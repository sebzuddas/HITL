...
k_s = 4;           % Spring constant (kg*m^2*s^-2)
k_d = 1.5;           % Viscous damping (kg*m^2*s^-1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Ex 2: DETERMINE POWER AMPLIFIER GAIN AND SATURATION LIMITS %%%%%%%%%%%%%
% Power amplifier
k_a         = 1;   % Power amplifier voltage gain
amp_sat_u   = 1;   % Power amplifier upper saturation limit (V)
amp_sat_l   = 1;   % Power amplifier lower saturation limit (V)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Ex 3: CONSTRUCT FAN MODEL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Fan voltage - thrust steady state behaviour
V_ab   = 1;          % Fan voltage input (V)
Fss_ab = 1;          % Steady-state fan thrust output (N)
% Fan voltage - thrust transient model.
tau = 1;             % 1st order time constant
